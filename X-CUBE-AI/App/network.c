...
#define AI_NETWORK_MODEL_SIGNATURE     "7282cae309f63a1fcf8e73dc4e73c35b"
...
#define AI_TOOLS_DATE_TIME   "Sat Jan 14 11:24:53 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 18708, 1, 1),
    18708, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_dense_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 248);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
